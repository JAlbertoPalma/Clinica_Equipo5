...
//        }
        ...
        try {
            ...
            List<Map<String, Object>> horarios = pacienteBO.consultarCitasDisponibles(idPaciente, fechaCita);
            System.out.println("Horarios disponibles para el paciente con id " + idPaciente);
